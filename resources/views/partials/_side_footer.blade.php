<div class="sidebar-footer">
    ...
    <a class="pull-left" href="{{ url('auth/logout') }}" data-toggle="tooltip" data-placement="top" data-original-title="Sing Out">
        <i data-feather="log-out" class="ht-15 text-danger"></i></a>
</div>