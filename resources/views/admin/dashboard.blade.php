                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-12 pd-t-20 d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                ...
                                <div class="tx-11 d-flex tx-gray-500"><span class="text-success mr-2 d-flex align-items-center"><i class="ion-android-arrow-up mr-1"></i>+535%</span>avg. per
                                    month</div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 pd-t-20 d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                ...
                                <div class="tx-11 d-flex tx-gray-500"><span class="text-success mr-2 d-flex align-items-center"><i class="ion-android-arrow-up mr-1"></i>+230%</span>avg. per
                                    month</div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 pd-t-20 d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                ...
                                <div class="tx-11 d-flex tx-gray-500"><span class="text-danger mr-2 d-flex align-items-center"><i class="ion-android-arrow-down mr-1"></i>-135%</span>avg. per
                                    month</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover mg-b-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$26,908</td>
                                    <td class="text-right"> <a href="" class="btn btn-label-primary btn-sm mg-y-5"><i class="fa fa-pencil"></i> Edit</a> <a href="" class="btn btn-label-success btn-sm mg-y-5"><i class="fa fa-link"></i>
                                            Add</a> <a href="" class="btn btn-label-danger btn-sm mg-y-5"><i class="fa fa-trash"></i> Delete</a> </td>
                                </tr>
                                <tr>
                                    <td><span>02</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>$17,376</td>
                                    <td class="text-right text-white"> <a href="" class="btn btn-label-primary btn-sm mg-y-5"><i class="fa fa-pencil"></i>
                                            Edit</a> <a href="" class="btn btn-label-success btn-sm mg-y-5"><i class="fa fa-link"></i> Add</a> <a href="" class="btn btn-label-danger btn-sm mg-y-5"><i class="fa fa-trash"></i>
                                            Delete</a> </td>
                                </tr>
                                <tr>
                                    <td><span>05</span></td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mg-b-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><span>01</span></td>
                                    <td><img src="{{ url('public/assets/images/user/user1.png')}}" class="img-fluid wd-40 ht-40 rounded-circle mr-2" alt="">Maria Grant</td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left"> <strong>67%</strong> </div>
                                        </div>
                                ...
                                <tr>
                                    <td><span>02</span></td>
                                    <td><img src="{{ url('public/assets/images/user/user2.png')}}" class="img-fluid wd-40 ht-40 rounded-circle mr-2" alt="">AB
                                        Mako</td>
                                    <td>
                                        <div class="clearfix">
                                ...
                                <tr>
                                    <td><span>03</span></td>
                                    <td><img src="{{ url('public/assets/images/user/user3.png')}}" class="img-fluid wd-40 ht-40 rounded-circle mr-2" alt="">Pusiz bia</td>
                                    <td>
                                        <div class="clearfix">
                                ...
                                <tr>
                                    <td><span>04</span></td>
                                    <td><img src="{{ url('public/assets/images/user/user4.png')}}" class="img-fluid wd-40 ht-40 rounded-circle mr-2" alt="">Hileri Soli</td>
                                    <td>
                                        <div class="clearfix">
                                ...
                                <tr>
                                    <td><span>05</span></td>
                                    <td><img src="{{ url('public/assets/images/user/user5.png')}}" class="img-fluid wd-40 ht-40 rounded-circle mr-2" alt="">John Deo</td>
                                    <td>
                                        <div class="clearfix">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-flex pd-y-15-force">
                                        <div class="avatar avatar-30 mr-2">
                                            <img src="{{ url('public/assets/images/user/user5.png')}}" class="img-fluid wd-40 ht-40 rounded-circle" alt="">
                                        </div>
                                        <div class="d-block">
                                ...
                                <tr>
                                    <td class="d-flex pd-y-10-force">
                                        <div class="avatar avatar-30 mr-2">
                                            <img src="{{ url('public/assets/images/user/user4.png')}}" class="img-fluid wd-40 ht-40 rounded-circle" alt="">
                                        </div>
                                        <div class="d-block">
                                ...
                                <tr>
                                    <td class="d-flex pd-y-10-force">
                                        <div class="avatar avatar-30 mr-2">
                                            <img src="{{ url('public/assets/images/user/user3.png')}}" class="img-fluid wd-40 ht-40 rounded-circle" alt="">
                                        </div>
                                        <div class="d-block">
                                ...
                                <tr>
                                    <td class="d-flex pd-y-15-force">
                                        <div class="avatar avatar-30 mr-2">
                                            <img src="{{ url('public/assets/images/user/user2.png')}}" class="img-fluid wd-40 ht-40 rounded-circle" alt="">
                                        </div>
                                        <div class="d-block">
                                ...
                                <tr>
                                    <td class="d-flex pd-y-10-force">
                                        <div class="avatar avatar-30 mr-2">
                                            <img src="{{ url('public/assets/images/user/user1.png')}}" class="img-fluid wd-40 ht-40 rounded-circle" alt="">
                                        </div>
                                        <div class="d-block">
